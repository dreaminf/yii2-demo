...
INSERT INTO `addressbook` VALUES ('45', '测试', '18', '1', '2016年05月03日', '1', 'zhl@kkb8.com', '029', '18526398563', '784440822', '1521816708', '1521816708', 'aFAfaSSDFGSADGSADG');
...
CREATE TABLE `cardinfo` (
  `rand_code` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '随机码',
  `user_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `sex` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `address` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `birth_day` varchar(40) CHARACTER SET utf8 DEFAULT NULL,
  `id_card` varchar(18) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`rand_code`)
